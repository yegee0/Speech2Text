...
class LibrispeechDataset(BaseDataset):
    def __init__(self, part, data_dir=None, *args, **kwargs):
        ...
        if part == "train_all":
            index = sum( #listeleri düz bir liste haline getirir
                [
    ...
    def _get_or_load_index(self, part): #jsona yükleme zaman kazanır
    ...
    def _create_index(self, part): #jsona yazma eğer yoksa
        index = []
        ...
        for flac_dir in tqdm(
            ...
            with trans_path.open() as f:
                for line in f: # satırları okur ve her örnek için bir sözlük oluşturur
                    # {
                    #   "path": "/full/path/to/84-121123-0000.flac",
